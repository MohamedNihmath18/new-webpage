    ...
    <div className="w-full bg-gray-900 text-white py-16 px-6">
      ...
      <div className="text-center max-w-5xl mx-auto mb-16">
        ...
        <p className="text-gray-300 text-lg sm:text-xl mb-6">
          We are a premier construction company with over 25 years of experience in the industry. We build exceptional spaces that stand the test of time. Our team is dedicated to quality, safety, and sustainability in every project.
        </p>
      </div>
...
<div className="w-full bg-gray-800 text-center py-12 mb-16">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    {/* Years of Experience */}
    <div className="bg-gray-900 p-8 rounded-lg shadow-xl transition-all duration-300 hover:border-2 hover:border-red-500 hover:scale-105">
      <h4 className="text-4xl font-bold text-red-500">25+</h4>
      <p className="text-gray-300 text-xl">Years of Experience</p>
    </div>
    {/* Satisfied Clients */}
    <div className="bg-gray-900 p-8 rounded-lg shadow-xl transition-all duration-300 hover:border-2 hover:border-red-500 hover:scale-105">
      <h4 className="text-4xl font-bold text-red-500">300+</h4>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-300">
              Over 25 years of experience delivering successful projects on time and within budget.
            </p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
